    ...
    return (
        <div className={cn("flex items-center gap-1.5 bg-muted/30 p-0.5 rounded-lg border border-border/50", className)} >
            ...
            <div className="flex items-center gap-1.5">
                <input
                    type="date"
                    className="bg-transparent text-xs font-mono text-foreground outline-none border-b border-transparent focus:border-accent w-24 min-h-[36px] dark:[color-scheme:dark]"
