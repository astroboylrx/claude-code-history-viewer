    ...
    return createPortal(
        <div className="fixed inset-0 z-50 pointer-events-none">
            ...
            >
                ...
                >
                    <div className="flex items-center gap-2.5">
                        ...
                        <div className="flex flex-col gap-0.5">
                            <span className={clsx("font-bold uppercase text-xs tracking-wide",
                        ...
                        {editedMdFile && (
                            <div
                                className={clsx(
                                    "flex items-center gap-1.5 ml-3 px-2 py-0.5 bg-amber-500/10 border border-amber-500/20 rounded text-xs text-amber-600 font-medium font-mono transition-colors",
                ...
                <div className="p-2 border-t border-border/50 bg-muted/10 rounded-b-lg flex justify-end gap-3 text-xs text-muted-foreground shrink-0 font-mono">
