      ...
      {isExpanded && (
        <div className="px-4 pb-3 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            <span className="inline-flex items-center gap-1 bg-muted/40 rounded-full px-2.5 py-0.5 text-xs">
            ...
            {selectedDate && (
              <button
                ...
                className="inline-flex items-center gap-0.5 bg-primary/10 rounded-full px-2.5 py-0.5 text-xs text-primary/80 hover:text-primary hover:bg-primary/15 transition-colors"
              >
