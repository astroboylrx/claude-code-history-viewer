        ...
        >
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="hidden lg:flex items-center gap-1.5">
                    ...
                    >
                        <SelectTrigger className="h-7 w-32 text-xs bg-muted/20 border-border/30 px-2">
                            <SelectValue placeholder={t("session.board.controls.tool")} />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectItem value="_ALL_" className="text-xs font-extrabold text-foreground uppercase tracking-wide">{t("session.board.controls.all")}</SelectItem>
                    ...
                    {shellCommandOptions.length > 0 && (
                        ...
                        >
                            <SelectTrigger className="h-7 w-40 text-xs bg-muted/20 border-border/30 px-2">
