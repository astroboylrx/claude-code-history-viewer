      ...
      <Renderer.Header
        ...
        rightContent={
          <div className={cn("flex items-center gap-2", layout.smallText)}>
            {subagentType && (
              <span className={cn("inline-flex items-center gap-1 px-2 py-0.5 font-mono text-xs uppercase tracking-wide", layout.rounded, badge.bg, badge.text, "border", badge.border)}>
