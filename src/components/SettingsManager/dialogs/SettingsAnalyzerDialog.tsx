...
const FileCard = React.memo<{
  ...
  return (
    ...
    >
      ...
      <Badge
        variant="outline"
        className={`absolute -top-2 right-3 text-3xs px-1.5 py-0 ${SCOPE_COLORS[analysis.scope]}`}
      >
          ...
          <div className="flex flex-wrap gap-1">
            {issue.affectedScopes.map((scope) => (
              <Badge
                key={scope}
                variant="outline"
                className={`text-3xs px-1.5 py-0 ${SCOPE_COLORS[scope] ?? ""}`}
              >
            ...
            <div className="space-y-3">
              ...
              <div className="bg-card border border-border/50 rounded-lg p-4 font-mono text-xs space-y-1">
                ...
                <div className="text-muted-foreground mt-3">
                  ...
                  <Badge variant="outline" className="text-3xs h-4 ml-2">
                ...
                <div className="pl-4 flex items-center gap-2 text-muted-foreground/60">
                  ...
                  <Badge variant="outline" className="text-3xs h-4 opacity-50">
                    gitignore
                  </Badge>
                </div>
              </div>
