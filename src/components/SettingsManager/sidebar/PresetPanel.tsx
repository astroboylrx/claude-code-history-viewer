        ...
        <div className="group relative rounded-lg border border-border/50 hover:border-border bg-card/50 hover:bg-muted/40 transition-all duration-150">
          ...
          {(summary.model || summary.mcpServerCount > 0) && (
            <div className="px-3 flex items-center gap-1.5">
              {summary.model && (
                <span className="inline-flex items-center rounded-full bg-indigo-500/10 px-2 py-0.5 text-xs font-mono font-medium text-indigo-400 whitespace-nowrap">
                  {summary.model}
                </span>
              )}
              {summary.mcpServerCount > 0 && (
                <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500/10 px-2 py-0.5 text-xs font-medium text-emerald-400 whitespace-nowrap">
