    ...
    return (
      <div className="rounded-lg border-2 border-accent/40 bg-card/50 p-3 space-y-2.5">
        <div className="flex items-center gap-2">
          ...
          <Badge variant="outline" className={`text-xs ${scopeColors[server.scope]}`}>
  ...
  return (
    <div className="group relative rounded-lg border border-border/50 hover:border-border bg-card/50 hover:bg-muted/40 transition-all duration-150 px-3 py-2.5">
      ...
      <div className="flex items-center gap-2">
        ...
        <Badge variant="outline" className={`text-xs shrink-0 ${scopeColors[server.scope]}`}>
          {scopeLabel[server.scope]}
        </Badge>
        {!readOnly && (
      ...
      <div className="mt-1.5 pl-5.5">
        <code className="text-xs text-muted-foreground/70 font-mono break-all whitespace-normal md:truncate md:whitespace-nowrap block">
