...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct ProviderPaginatedParams {
    pub provider: String,
    pub session_path: String,
    #[serde(default)]
    pub offset: Option<usize>,
...
pub async fn open_github_issues() -> Result<Json<Value>, ApiError> {
    let url = "https://github.com/astroboylrx/claude-code-history-viewer/issues/new";
    Ok(Json(
...
handler_json!(
    ...
    ProviderPaginatedParams,
    |p: ProviderPaginatedParams| async move {
